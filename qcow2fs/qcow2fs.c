/*
 * qcow2fs.c --- a program which allows you to attach an ext2fs
 * filesystem in a qcow2 image and play with it.
 *
                ...
                char *data_filename, char *undo_file)
{
    ...
    io_manager io_ptr = qemu_io_manager;
    ...
    if (data_filename) {
        ...
        retval = qemu_io_manager->open(data_filename, 0, &data_io);
        if (retval) {
